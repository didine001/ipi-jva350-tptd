...
public class SalarieAideADomicileService {
    ...
    public SalarieAideADomicileService() {
        // Initialize necessary components or dependencies here.
        // Example: this.someDependency = new SomeDependency();
    }
    ...
    public void ajouteConge(SalarieAideADomicile salarieAideADomicile, LocalDate jourDebut, LocalDate jourFin)
        ...
        if (joursDecomptes == null || joursDecomptes.isEmpty() || salarieAideADomicile.getMoisEnCours() == null) {
            throw new SalarieException("Invalid dates or month in progress");
        }
